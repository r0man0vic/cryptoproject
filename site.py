...
events={"Growth":[
        ...
        "Crash":[
                ...
                {"date":"2026-01-25","title":"U.S Government Shutdown (2025)","description":"The government shutdown, which was considered the longest in US history, caused the Treasury General Account (TGA) to swell, locking up liquidity in the Fed's vault and starving risk assets like crypto. Investors pulled back from riskier assets, with market analysts noting a shift towards "profit-taking" and "de-risking" while waiting for economic data, which was delayed by the shutdown.","window":11,"image":"pics/possible.jpg"},
