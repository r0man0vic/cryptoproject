...
events={"Growth":[
                  ...
                  {"date":"2020-12-20","title":'BTC Is Called "Gigital Gold" (2020-2021)',"description":'Two significant figures in business Ray Dalio and Stanley Druckenmiller called Bitcoin "Digital Gold" and said, that its a good investment, Stanley Druckenmiller even said that he holds some. Those statements from significant people caused increased intrests from regular people and investors, and thus - price growth.',"window":90,"image":"pics/gold.jpg"},
                  ...
                  {"date":"2025-05-31","title":"Consolidation Phase (2025) + Growth Conclusion","description":"Between April and July 2025, Bitcoin moved through a consolidation phase as the market stabilized after previous gains. Continued institutional demand supported prices, while broader macroeconomic conditions influenced investor behavior, leading to more gradual and controlled price movement. \n\n**CONCLUSION About GROWTHS Of BTC**: **Bitcoin growth is primarily driven by strong market sentiment and investor hype, always amplified during periods of global stability. When economic conditions are stable and uncertainty is low, investor confidence increases, leading to greater demand and sustained upward price movement.**","window":52,"image":"pics/2025.jpg"}],
        "Crash":[
                {"date":"2018-04-16","title":"Bubble Burst (2018)","description":'Bitcoin crashed after the "2017 Boom" as the speculative bubble burst, with hype collapsing and panic selling - driving price sharply lower.',"window":120,"image":"pics/bear.jpg"},
                {"date":"2020-02-18","title":"COVID-19 Market Crash (2020)","description":"Bitcoin dropped sharply as the COVID-19 pandemic triggered global panic across financial markets, causing investors to sell risk assets and move into safer positions. Panic increased selling pressure and reduced demand, contributing to a rapid decline in price.","window":29,"image":"pics/covid.jpg"},
                {"date":"2021-05-19","title":"China Mining Ban + Elon Musk Tweets (2021)","description":"China’s mining shutdown triggered a sharp correction, as it was a lead. Elon Musk's tweets regarding energy problems triggered mining concerns which is the main source of obtaining Bitcoin.","window":36,"image":"pics/china.jpg"},
                ...
                {"date":"2025-02-16","title":"Tariffs Affect BTC (2025)","description":"The announcement of 25% tariffs on Canada and Mexico, and 10% on China by the U.S. administration, created severe volatility. These tariffs sparked fears of a global economic slowdown, because China is one of main countries in this industry, pushing investors away from risky assets like Bitcoin and crypto in general.","window":22,"image":"pics/new.jpg"},
