...
events={"Growth":[],
        "Drop":[{"date":"2022-12-01","title":"Ms sells btc","description":"promised not to sell it but sold it","window":20},
                ...
                {"date":"2018-04-16","title":"Bear market","description":"The 2017 bull run created massive speculation. When the bubble popped, the entire crypto market entered a deep bear cycle.","window":120}]}
